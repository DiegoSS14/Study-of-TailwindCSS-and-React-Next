...
export default function MenuItem({icon: Icon, title, link}: MenuItemProps) {
    return(
        <Link href={link} className="flex items-center gap-2 px-4 py-3 rounded-md transition-colors duration-500 hover:bg-zinc-950">
            ...
            <span className="break-all text-zinc-200 leading-4.5">{title}</span>
        </Link>
    )
}